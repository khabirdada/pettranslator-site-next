---
title: "Cat Body Language: A Vet-Behaviorist Guide"
slug: "cat-body-language"
description: "Cat body language runs on ear angle, pupil dilation, whisker carriage, tail position, and posture. Learn to read the signals cats give before they escalate."
...
The same rule applies when a [cat slaps with one paw](/blog/why-do-cats-slap-with-their-paws): target, trigger, tension and the movement that follows matter more than the raised paw alone.
...
The dedicated guide to [cat whisker positions](/blog/cat-whisker-positions-meaning) explains why forward whiskers can appear during curiosity, hunting, conflict or pain, and why the rest of the face must change the interpretation.
...
**Crouched.** The cat lowers the body close to the ground with the limbs ready to move. Hunting, fear, defensive tension and pain can all produce a low posture, while a soft loaf may simply be rest. The [cat crouching body-language guide](/blog/cat-crouching-body-language) compares the face, weight, tail, trigger and medical warning signs.
...
The dedicated guide to [cat stress signs](/blog/cat-stress-signs) extends this momentary body-language read to chronic changes in hiding, grooming, appetite, play, social behavior and litter-box use.
...
**Cats hiding under the bed aren't "being dramatic."** A cat who relocates to a hiding spot after a change in the household (a visitor, a new pet, a renovation, a vet visit) is regulating their own arousal in the most species-typical way available. The hide is functional, not emotional theater. Forcing them out almost always extends the recovery time. More in [cat hiding under bed](/blog/cat-hiding-under-the-bed).
