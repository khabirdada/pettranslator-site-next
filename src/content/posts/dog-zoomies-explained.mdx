---
title: "Dog Zoomies Explained: The Behavioral Science of FRAPs"
slug: "dog-zoomies-explained"
description: "Zoomies (FRAPs) are normal canine arousal regulation — bursts of high-energy running that release pent-up energy. Marc Bekoff coined the term."
...
A dog showing compulsive repetitive movement that doesn't fit the FRAP profile above should see a vet first to rule out medical causes, then a credentialed behavior consultant (CDBC, [IAABC](https://iaabc.org/), or a board-certified veterinary behaviorist — DACVB) if behavior support is needed.
</Callout>
