...
description: "The N+1 rule means one litter box per cat plus one extra. Learn how placement, box size, substrate and cleaning reduce conflict in multi-cat homes."
tldr: "Use one litter box per cat plus one extra, placed in separate accessible locations rather than lined up as one station. Box size, substrate, cleanliness, escape routes, and each cat's health matter as much as the number."
...
The broader guide to [resource guarding in cats](/blog/resource-guarding-in-cats) maps the same quiet access problem around food, water, resting places, rooms and people without relying on a dominance label.

When resource pressure escalates into chasing or wrestling after dark, use the [nighttime cat-fighting guide](/blog/why-do-my-cats-fight-at-night) to distinguish play from conflict.
...
Start with three boxes: one per cat plus one extra. Put them in separate useful locations so one cat cannot guard a single doorway or block access to every option.

### Do litter boxes side by side count as separate boxes?

They provide more substrate but function as one resource station because a cat can monitor or block the whole area. Separate locations offer more meaningful choice and safer access.

### What if my home cannot fit the full N+1 number?

Use as many large, uncovered boxes as the space safely allows, spread them across distinct locations and clean them frequently. Do not force an unrelated location just to satisfy the count. New house-soiling still needs a veterinary assessment.
