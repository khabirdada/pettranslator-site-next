...
**Scent.** A new detergent, shampoo, diffuser, or scented candle. Clothes carrying another animal's scent. And the classic: one cat returns from the vet smelling like the clinic and is attacked by a housemate who has known them for years. That is non-recognition aggression, not a personality conflict, and it resolves with a structured reintroduction rather than with punishment.
