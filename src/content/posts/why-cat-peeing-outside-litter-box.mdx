---
title: "Why Is My Cat Peeing Outside the Litter Box? A Behaviorist's"
slug: "why-cat-peeing-outside-litter-box"
description: "Cats peeing outside the box is the #1 reason cats end up in shelters — and it's almost always solvable. Half of cases are medical."
category: "cat-behavior"
tags: ["litter-box", "behavior-questions", "cat-questions", "stress-signals"]
author: "khabir-mughal"
publishedAt: "2026-04-06"
updatedAt: "2026-04-06"
heroImage: "/blog/heroes/why-cat-peeing-outside-litter-box.webp"
...
Look for one of these credentials: **Dip. [ACVB](https://www.dacvb.org/)** (Diplomate of the American College of Veterinary Behaviorists — a board-certified veterinarian), **CCBC** (Certified Cat Behavior Consultant through IAABC), or **CAAB** (Certified Applied Animal Behaviorist). All three signal force-free, evidence-based methodology. The AAFP cat-friendly practice directory lists vets with additional feline behavior training. The full credential framework is covered in our piece on [how to find a credentialed behaviorist](/blog/how-to-find-credentialed-behaviorist).

<Callout type="referral">
A cat soiling outside the box is a medical case until proven otherwise. The [IAABC](https://iaabc.org/) and ACVB directories list credentialed feline behavior professionals by region — but the vet visit comes first.
</Callout>
