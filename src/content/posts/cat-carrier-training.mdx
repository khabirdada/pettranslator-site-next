---
title: "Cat Carrier Training That Doesn't Stress Cats"
slug: "cat-carrier-training"
description: "Cat carrier training reverses the vet-only association most cats form. A stepwise desensitization protocol turns the carrier into a neutral, then positive space."
tldr: "Leave a suitable carrier open as ordinary furniture, then build voluntary entry with familiar bedding and rewards in small steps. Do not chase, corner, or force-load the cat except when immediate medical safety makes transport unavoidable."
...
That familiar open carrier can also become a useful hide in the [safe room after a house move](/blog/cat-hiding-after-moving-house), provided the cat can enter and leave freely.
