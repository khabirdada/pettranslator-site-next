---
title: "Why Does My Cat Sit With Its Back to Me?"
slug: "why-does-my-cat-sit-with-back-to-me"
description: "When a cat sits with its back to you, it's a documented high-trust signal — the opposite of what most humans assume, grounded in feline vigilance and predation."
...
For ongoing behavioral concerns once medical causes are ruled out, look for credentialed positive-reinforcement professionals — [IAABC](https://iaabc.org/)-certified feline behavior consultants and [AVSAB](https://avsab.org/)-aligned veterinary behaviorists are the relevant credentials. Avoid anyone using punishment-based methods on cats; the evidence for harm is clear and the evidence for effectiveness is not.
