---
title: "Dog Tail Position Chart: Full Reference Guide"
slug: "dog-tail-position-chart"
description: "Dog tail position carries more information than the wag. A full reference to tail heights, motions, and stiffness — and the emotional state behind each one."
...
Look for **CDBC**, **CSAT**, **[IAABC](https://iaabc.org/)**, **KPA-CTP**, or **Fear Free** credentials. Avoid trainers who reference dominance, alpha rolls, or pack leadership; the [AVSAB](https://avsab.org/) has explicitly rejected these methods. For tail signals tied to fear specifically, see the [fear body language](/blog/signs-your-dog-is-stressed) reference.
