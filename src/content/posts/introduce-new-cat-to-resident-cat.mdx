...
If one cat starts controlling food, a safe room or the route through a doorway, use the [cat resource-guarding guide](/blog/resource-guarding-in-cats) alongside the introduction plan.
