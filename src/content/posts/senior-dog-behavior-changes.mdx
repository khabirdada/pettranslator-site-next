---
title: "Senior Dog Behavior Changes: Medical First"
slug: "senior-dog-behavior-changes"
description: "Senior dog behavior changes mimic anxiety or stubbornness but are usually medical — arthritis, cognitive dysfunction, hearing loss, or organ decline sitting underneath."
tldr: "A senior dog's new withdrawal, night waking, house-soiling, irritability, disorientation, or reluctance to move is not automatically normal aging. Pain, sensory loss, organ disease, and cognitive dysfunction need a veterinary assessment before behavior training."
...
The guide to a [dog sitting alone in another room](/blog/why-does-my-dog-sit-alone-in-another-room) separates longstanding, comfortable solitude from a new withdrawal pattern and gives a short observation log.
...
Barking or twitching while the dog remains asleep is a different pattern; use the [sleep-barking guide](/blog/dog-barking-in-sleep) to compare ordinary REM activity with seizure signs.
...
Pain may also look inconsistent. Do not assume a senior dog is [faking an injury](/blog/do-dogs-fake-injuries) because a limp fades during excitement or returns after rest.
