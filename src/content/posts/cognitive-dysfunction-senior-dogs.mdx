---
title: "Cognitive Dysfunction in Senior Dogs: Signs"
slug: "cognitive-dysfunction-senior-dogs"
description: "Canine Cognitive Dysfunction is the dog Alzheimer's — affecting 14-35% of dogs over 8 and widely under-diagnosed. Learn the DISHAA warning signs to catch it early."
category: "dog-behavior"
tags: ["senior-dog", "cognitive-dysfunction", "behavior-questions", "dog-questions"]
author: "khabir-mughal"
publishedAt: "2026-02-21"
updatedAt: "2026-02-21"
heroImage: "/blog/heroes/cognitive-dysfunction-senior-dogs.webp"
...
For a senior dog showing new-onset behavior changes, working with both a primary care veterinarian and a veterinary behaviorist (ACVB diplomate) is the gold standard. The [IAABC](https://iaabc.org/) and [AVSAB](https://avsab.org/) websites maintain searchable directories of credentialed professionals by region.
</Callout>
...
For dogs whose CDS is compounded by [pacing at night](/blog/dog-pacing-at-night), the environmental modifications above are often the highest-use intervention an owner can make.
...
- **[AAHA](https://www.aaha.org/) Senior Care Guidelines for Dogs and Cats** (current edition). The American Animal Hospital Association's general-practice protocol for senior wellness, including cognitive screening.
